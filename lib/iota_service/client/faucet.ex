defmodule IotaService.Client.Faucet do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> IotaService.Client.Faucet.request_funds("0xYOUR_IOTA_ADDRESS")
      {:ok, %{status: 202, body: ...}}

      iex> IotaService.Client.Faucet.request_funds("0xADDRESS", url: "https://custom-faucet.example.com/gas")
      {:ok, %{status: 202, body: ...}}
  """
  ...
  defp faucet_url(opts) do
    Keyword.get_lazy(opts, :url, fn ->
      Application.get_env(:iota_service, :faucet_url, @default_faucet_url)
    end)
  end
end
