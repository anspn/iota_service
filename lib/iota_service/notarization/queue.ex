defmodule IotaService.Notarization.Queue do
  @moduledoc """
  ...
  def enqueue(data, tag \\ "iota_service") when is_binary(data) do
  ...
  defp process_job(job) do
    IotaService.Notarization.Server.create_payload(job.data, job.tag)
  end
end
